...
| [changelog-release](#changelog-and-release) | 📦 Release & Changelog | Generates changelogs and creates releases |
| [conventional-commit](#conventional-commit) | 🔍 CI & Validation | Validates commits against conventional commit rules |
| [docker-build-push-ecr](#docker-build-and-push-to-ecr) | 🚀 Build & Deploy | Builds and pushes Docker images to ECR |
| [docker-security-scan](#docker-security-scan) | 🔒 Security | Scans Docker images for vulnerabilities |
...
| [readme-ai-generator-v2](#readme-ai-generator-v2) | 📚 Documentation | Generates READMEs using AI |
| [release](#tofu-release) | 📦 Release & Changelog | Creates a release and updates README versions |
...
### tofu-test
Tests Tofu modules. Use this workflow to ensure that your Tofu modules are working correctly.
...
Scans Docker images for vulnerabilities. Use this workflow to ensure that your Docker images are secure.
...
Builds and pushes Docker images to ECR. Use this workflow to build and deploy your Docker images.
...
## 📦 Release & Changelog
### changelog-release
Generates changelogs and creates releases. Use this workflow to automate your release process.
...
### release
Creates a release and updates README versions. Use this workflow to automate your release process.
...
Generates READMEs using AI. Use this workflow to automate your README generation.
...
### tf-docs
Generates Terraform documentation. Use this workflow to automate your Terraform documentation.
...
Updates the README with available actions. Use this workflow to automate your README updates.
